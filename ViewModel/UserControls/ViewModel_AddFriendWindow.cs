...
{
    public class ViewModel_AddFriendWindow : BaseViewModel
    {
        private readonly Action<Thickness> _setMarginAction;
        private double _relLeft = 0.35;
        private double _relTop  = 0.25;

        private string _title = "Add Friend";
        ...
        public ViewModel_AddFriendWindow()
        {
            _setMarginAction = m => MainWindow.Instance.addFriendWindow.Margin = m;
        ...
        private void Close() => MainWindow.Instance.addFriendWindow.Visibility = Visibility.Hidden;
